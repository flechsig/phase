#!/usr/bin/perl -w
#  File      : /home/pss060/sls/flechsig/phase/admin/filelist.pl
#  Date      : <14 Oct 99 08:56:40 flechsig> 
#  Time-stamp: <15 Oct 99 09:23:54 flechsig> 
#  Author    : Flechsig Uwe OVGA/203a 4535, flechsig@psi.ch

# do something with a filelist

die "usage: filelist [release]\n" unless @ARGV; 
