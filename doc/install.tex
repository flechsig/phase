...
%  Time-stamp: <28 Oct 03 11:02:17 flechsig> 
...
The calculation prinziple and basic ideas of the program are explained in \cite{BAHRDT95a} and \cite{BAHRDT95b}.
...
installation the file system is generated and PHASE can be used on your system.
Later you have to set up the appropriate environment starting the setup program 
(\prog{phaseinit.com}) at the begining of the session. That program and some
other files should be found after installation in your PHASE directory-
default: \~/phase. PHASE can be removed as simple as installed: \prog {make
clear} \footnote {The files HIGZ\_WINDOWS.DAT and the makefile itselve are not
...
\begin{enumerate}         
   ...
   (at BESSY) \prog {copy prg\_root:[phase]makefile *} will copy the makefile
   to your current directory. 
  \item run the makefile  \prog{make install}.
\end{enumerate}
...
program \prog {phaseinit.com} detects your system and sets the right symbols
