...
print,''
print,'--------------------------------------------------------------'
print,'     LTPtest 4 Qudrantenmuster
print,'--------------------------------------------------------------'
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; physikal. Parameter
waist = 2.0D       ; gaussian beam waist [mm]
...
phi=180D
bild_invers= 0
nur_phasen_gitter = 1D   ; 1 ... YES, 0... entspricht Spiegel mit einer Stufe
apertur = 230
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;             und dann 90 Grad gedreht auch die Haelfte des Strahles 180 Grad Phase schieben
   ...
   ere = beam.zezre(*,0:ygrenze/2-1)
   eim = beam.zezim(*,0:ygrenze/2-1)
   beam.zezre(*,0:ygrenze/2-1)=ere * cos(phi *!DPI/180D) - eim * sin(phi *!DPI/180D)
   beam.zezim(*,0:ygrenze/2-1)=ere * sin(phi *!DPI/180D) + eim * cos(phi *!DPI/180D)
