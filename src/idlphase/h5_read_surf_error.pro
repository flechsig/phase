...
; Time-stamp: <17 Jun 14 11:40:49 flechsig> 
...
; idl> l= 0.0
; idl> u= slope* w
; idl> h5_read_surf_error, file, 'M1', u, w, l
;
...
H5D_READ, a_dataset_id, u2
H5D_READ, u_dataset_id, u1
H5D_READ, w_dataset_id, w
H5D_READ, l_dataset_id, l
