...
PRO SavePhaseResults, beam, MainFileName
...
SaveEzReal,beam,MainFileName+'-ezrec'
SaveEzImag,beam,MainFileName+'-ezimc'
SaveEyReal,beam,MainFileName+'-eyrec'
SaveEyImag,beam,MainFileName+'-eyimc'
