C  ***  CONVERT PORT3 PROGRAMS FROM FORTRAN 77 TO FORTRAN 77 SUBSET...
...
C
      ...
      CHARACTER*2 C12, C34
      INTEGER I, J, MODE
      EQUIVALENCE (C(1),LINE,C12), (C(3),C34)
C
C  ***  BODY  ***
C
      MODE = 0
 ...
 20   FORMAT(A80)
      IF (C12 .EQ. 'C/') THEN
         IF (C34 .EQ. '6S' .OR. C34 .EQ. 'C ' .OR. C34 .EQ. '7 ') THEN
                 MODE = 1
         ELSE IF (C34 .EQ. '7S' .OR. C34 .EQ. 'R ' .OR. C34.EQ.'6 ')THEN
                 MODE = 2
         ELSE
                 MODE = 0
         END IF
