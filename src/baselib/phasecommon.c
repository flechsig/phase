...
/*  Time-stamp: <10 Mar 06 12:19:22 flechsig>  */
...
int phaBLInit(struct BeamlineType *blptr)
{
   blptr= (struct BeamlineType *)xmalloc(sizeof(struct BeamlineType));
   return 1;
}
...
/*
   ...
   use a static struct
*/
int phaBLInit_static(struct BeamlineType *blptr)
{
   static struct BeamlineType Bl;
   blptr= &Bl;
   return 1; 
}
