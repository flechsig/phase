...
#  Time-stamp: <08 Jul 11 10:54:11 flechsig> 
...
CONFIG    += qt debug
LIBS      += ../phase/drift_8.o ../phase/phasefor.o ../phase/make_matrix_8.o ../phase/taylor-ops.o ../phase/q0_q1_q2_8.o ../phase/replace_wl_in_ypzp.o ../phase/replace_wl_in_u.o \
	../phase/replace_6v4v.o ../phase/rekursiv_2d_8.o ../phase/fdet_8.o ../phase/fgmapidp_8.o ../phase/get_partial_etc.o -L/opt/intel/intel-10.0/fc-10.0/lib \
