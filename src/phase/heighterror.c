...
void apply_height_error_(int *blp, double *eyre, double *eyim, double *ezre, double *ezim, double *z, double *y, double *dz, double *dy)
{
...
#ifdef DEBUG
  printf("\ndebug: %s, ApplyHeightError_ called\n", __FILE__);
#endif
    /// some code
